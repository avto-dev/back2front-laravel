...
.PHONY : help build latest install lowest test-php test test-php-cover test-cover shell clean
.DEFAULT_GOAL : help
...
test: test-php ## Execute all tests and linters
...
test-cover: test-php-cover ## Execute php tests with coverage
